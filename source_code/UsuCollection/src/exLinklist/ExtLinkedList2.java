...
public class ExtLinkedList2<E> {
	...
	public void add(int index, E e) {
		...
		// node2节点
		ExtLinkedList2<E>.Node oldNode = getNode(index);
		if (oldNode != null) {
			// node1
			ExtLinkedList2<E>.Node oldPrevNode = oldNode.prev;
			// node4
	...
	public void remove(int index) {
		...
		if (oldNode != null) {
			// 2.获取删除元素的上下节点
			// node3
			ExtLinkedList2<E>.Node oldNextNode = oldNode.next;
			// node1
			ExtLinkedList2<E>.Node oldPrevNode = oldNode.prev;
